...
- 可用性保護
 ...
 - 備份(Backup)
   -指將【檔案系統或資料庫系統中的資料加以複製】，一旦【發生災難或錯誤操作時】，得以方便且及時地【恢復系統的有效資料和正常運作】。 
  - 容錯、備援及負載平衡
  - 容錯(Fault tolerance)
  
  - 是使系統在部分組件（一個或多個）發生故障時仍能正常運作的能力，高可用性或生命攸關系統中尤為追求容錯。系統部分故障時，維護功能的能力也稱為柔性降級或從容退化（graceful degradation）
  - 備援(Backup)
   - 指將【檔案系統或資料庫系統中的資料加以複製】，一旦【發生災難或錯誤操作時】，得以方便且及時地【恢復系統的有效資料和正常運作】。
  - 負載平衡(Load balancing)
